...
let foodsArray = ['pizza', 'steak', 'ribs', 'bread and butter'];
...
console.log('Second food is', foodsArray[1]);
...
foodsArray.push('fried chicken');
console.log("Added fried chicken to end,", foodsArray);
...
foodsArray.unshift("oysters");
console.log(`Added a new food to the beginning: ${foodsArray}`);
...
replacedFood = foodsArray[1];
foodsArray[1] = "cheese";
console.log("Replaced",replacedFood,"with cheese");
console.log("Foods are now", foodsArray);
...
let newArray = foodsArray.concat(animalArray);
newArray.sort();
newArray.reverse();
